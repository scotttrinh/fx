                ...
                while (true) {
                    ...
                    switch (admitted) {
                        ...
                        .completed => |completed| {
                            ...
                            if (self.resolveChildStatus(alloc, completed.child_id, completed.observation.metrics, effectiveDefaults(options.defaults, request.override()), options.model_capability_resolver)) |child_status| {
